      ...
      <div className="mx-auto max-w-6xl px-6 sm:px-8">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-3">
          {testimonials.map((t) => (
            <figure
              key={t.name}
              className="flex flex-col rounded-[3rem] bg-paper p-10 shadow-[0_2px_20px_rgba(0,0,0,0.04)] transition-all duration-300 hover:shadow-[0_16px_50px_-12px_rgba(239,74,134,0.5)] sm:rounded-full sm:p-14"
            >
