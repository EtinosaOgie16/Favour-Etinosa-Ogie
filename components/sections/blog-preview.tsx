          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-3">
            {posts.map((post) => (
              <Link
                key={post.id}
                href={`/blog/${post.slug}`}
                className="group flex flex-col overflow-hidden rounded-[2.5rem] border border-black/5 bg-cream transition-all duration-300 hover:border-accent/40 hover:shadow-[0_16px_50px_-12px_rgba(236,72,153,0.5)]"
              >
